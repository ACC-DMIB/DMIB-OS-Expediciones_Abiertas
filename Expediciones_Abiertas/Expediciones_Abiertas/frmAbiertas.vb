...
Public Class frmAbiertas
    ...
    Private Sub dgvExpediciones_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvExpediciones.CellDoubleClick
        ...
        If respuesta = 6 Then
            ...
            Dim dt As DataTable = dgvPedidos.DataSource
            ...
            For Each row As DataRow In dt.Rows
                ...
                If row("Estado OS") <> "CLOSED" Then
                    MsgBox("El pedido " & row("Pedido OS") & " tiene el estado " & row("Estado OS") & " cierrelo antes de cerrar la expedicion")
                    Exit Sub
                End If
            Next
