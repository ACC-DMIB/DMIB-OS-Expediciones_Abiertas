...
Public Class Consultas
    ...
    Public Function lineasPedido(PedidoOS As String) As DataTable
        ...
        cmd.CommandText = "SELECT        production_item.number, component_set.name, production_item.note, component_set.sap_code, production_item.quantity, production_item.status as Estado
